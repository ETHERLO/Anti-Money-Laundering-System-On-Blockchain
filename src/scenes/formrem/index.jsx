...
var contractaddress = "0x9c77c4780012515731E042a4E10ec780c97776aF";
     ...
     await instance.methods.removeOrganization(ethaddress).send({
          from : account
        });
  ...
  return (
    <Box m="20px">
      <Header title="REMOVE A Organization" subtitle="Remove a  Organization Profile" />
        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Box display="flex" justifyContent="center" mt="20px">
              <Button onClick={Remove} type="submit" color="secondary" variant="contained">
                Remove organization
              </Button>
            </Box>
          </form>
